...
const CommonUtils = {
    ...
    applyDeterministicWear: function (cardEl, card) {
        ...
        const nickAlpha = (0.22 + rand() * 0.16).toFixed(3);
        const nickX = Math.round(12 + rand() * 70);
        const nickY = Math.round(10 + rand() * 75);
        const chipAlpha = rand() > 0.72 ? (0.5 + rand() * 0.25).toFixed(3) : '0';
        const chipX = Math.round(4 + rand() * 20);
        const chipY = Math.round(4 + rand() * 20);
        ...
        cardEl.style.setProperty('--wear-nick-alpha', nickAlpha);
        cardEl.style.setProperty('--wear-nick-x', `${nickX}%`);
        cardEl.style.setProperty('--wear-nick-y', `${nickY}%`);
        cardEl.style.setProperty('--wear-chip-alpha', chipAlpha);
        cardEl.style.setProperty('--wear-chip-x', `${chipX}%`);
        cardEl.style.setProperty('--wear-chip-y', `${chipY}%`);
