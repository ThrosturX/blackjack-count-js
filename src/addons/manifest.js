window.AddonManifest = {
    addons: [
        ...
        },
        {
            id: 'classic-faces',
            label: 'Classic Faces',
            description: 'Replaces the standard pattern with the classic English pattern (also known as the Anglo-Saxon or International pattern). The face cards feature easily distinguishable and recognizable scalable vector graphics made by Wikimedia user Ekirahardian.',
        ...
        },
        {
            id: 'worn-cards',
            label: 'Worn Cards',
            description: 'Adds worn card edges, faded inks, scuffed textures, desaturation. Extremely beautiful, but some cards can be a little bit difficult to read at a glance (depending on the deck style).',
