(() => {
    ...
    const scheduleOrca = () => {
        ...
        orcaTimer = setTimeout(() => {
            ...
            el.style.setProperty('--orca-start-x', `${startX.toFixed(2)}%`);
            el.style.setProperty('--orca-end-x', `${endX.toFixed(2)}%`);
            el.style.setProperty('--orca-start-y', `${startY.toFixed(2)}%`);
            el.style.setProperty('--orca-end-y', `${endY.toFixed(2)}%`);
